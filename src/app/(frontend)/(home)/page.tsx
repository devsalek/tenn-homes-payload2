        ...
        <section className="py-16 bg-accent text-accent-foreground">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 tablet:grid-cols-2 desktop:grid-cols-4 gap-6">
              {/* Property Card 1 */}
              <a href="/home-static/asdasd/asdasd/asd" className="group">
                <Card className="overflow-hidden py-0 relative group-hover:shadow-md gap-0">
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-bold text-lg mb-1">Amazing Home For Family</h3>
